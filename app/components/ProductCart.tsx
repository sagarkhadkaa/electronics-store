...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className='relative bg-white rounded-lg shadow-md p-2 w-[250px] max-w-[250px] font-poppins mx-12 m-8'>
      <div
      ...
      <h3 className='text-center text-black mt-4 mb-2 text-lg'>{title}</h3>
      <button
